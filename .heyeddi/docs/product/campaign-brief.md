...
Three hardware **stages** (deepest discount first), plus multi-box mesh packs.
...
### Multi-box mesh packs (staged)

| Pack | Super EB | Early | Standard | Soft limit (Super EB) | Snapshot |
|------|----------|-------|----------|------------------------|----------|
| Household Duo (2 boxes) | **$759** | **$819** | **$859** | ~25 | Saves ~$40 vs 2 singles; multi-node mesh |
| Mesh Trio (3 boxes) | **$1,099** | **$1,189** | **$1,249** | ~15 | Saves ~$100 vs 3 singles; multi-node mesh |
...
Duties/taxes: **not included**; stated on KS page. Update after carrier quotes; these are the defaults for the page draft.
...
| United States | **$45** | |
| Canada | **$55** | |
| EU / UK | **$65** | Buyer handles VAT/import |
| Rest of world | **Not offered at launch** | Add post-campaign if demand |

## Risks & challenges (locked outline for KS)

- OEM lead times and N100/N150 board swaps  
- Import/customs variance vs ~$305 landed planning cost  
